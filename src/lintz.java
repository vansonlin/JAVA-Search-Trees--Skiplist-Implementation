...
//            System.out.println("Height = " + rbtree.getHeight());
    ...
    public void go(String[] args){
        ...
        try {
            ...
            List<List<String>> dataList = readFile(); // read file, throw exception if the file not in correct format
     ...
     **/
    private List<List<String>> readFile() throws Exception{
        // read file
...
//                String[] s = line.split(" "); // space separated
